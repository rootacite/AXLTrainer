...
class TrainConfig:
    ...
    optimizer_args: str = (
        '"decouple=True" "weight_decay=0.04" "d_coef=1" '
    ...
    sample_prompts: str = (
        ...
        "low twintails, grey hair, looking at viewer, dress, twintails,large breasts,closed mouth,shy,smile,lying on bed,breasts,nipples,pussy sex,full body,normal postion,spread legs,panties around one leg"
    )
    sample_negative: str = "lowres, bad anatomy, (mosaic censoring:1.3)"
    sample_width: int = 768
    sample_height: int = 768
    sample_steps: int = 28
    sample_seed: int = 1094679412937368
